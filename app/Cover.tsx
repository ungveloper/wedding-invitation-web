...
const LAYER_CLASS =
  'absolute m-0 block bg-center bg-no-repeat p-0 pointer-events-none select-none';
  ...
  useEffect(() => {
    ...
    const startAnimations = () => {
      ...
      if (reducedMotionQuery.matches) {
        groomFloat.style.transform = 'none';
        brideFloat.style.transform = 'none';
        return;
      }
      ...
      const groomAnimation = groomFloat.animate(
        [
          ...
          {
            offset: 0.3,
            transform: `translate3d(${-0.6 * cqw}px, ${-0.9 * cqw}px, 0)`,
          },
          {
            offset: 0.65,
            transform: `translate3d(${0.7 * cqw}px, ${-0.3 * cqw}px, 0)`,
          },
          {
            offset: 1,
            transform: 'translate3d(0, 0, 0)',
      ...
      const brideAnimation = brideFloat.animate(
        [
          ...
          {
            offset: 0.35,
            transform: `translate3d(${0.7 * cqw}px, ${-0.6 * cqw}px, 0)`,
          },
          {
            offset: 0.7,
            transform: `translate3d(${-0.4 * cqw}px, ${0.5 * cqw}px, 0)`,
          },
          {
            offset: 1,
            transform: 'translate3d(0, 0, 0)',
      ...
      animations = [groomAnimation, brideAnimation];
    };

    const resizeObserver = new ResizeObserver(startAnimations);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className={`${LAYER_CLASS} left-[19.103175%] top-[91.729395%] h-[3.375527%] w-[5.5%] rotate-[-10deg] bg-[url('/images/cover/heart-red-bottom-left.svg')] bg-size-[100%_100%]`}
          aria-hidden="true"
        />
        <span
          className={`${LAYER_CLASS} left-[88.375%] top-[61.673699%] h-[3.23488%] w-[4.5%] bg-[url('/images/cover/heart-red-middle-right.svg')] bg-size-[100%_100%]`}
          aria-hidden="true"
        />
        <span
          className={`${LAYER_CLASS} left-[5.55555%] top-[54.708439%] h-[3.23488%] w-[4.5%] -rotate-12 bg-[url('/images/cover/heart-white-middle-left.svg')] bg-size-[100%_100%]`}
          aria-hidden="true"
        />
        <span
          className={`${LAYER_CLASS} left-[10.125%] top-[14.914065%] h-[3.23488%] w-[5%] rotate-[-13deg] bg-[url('/images/cover/heart-red-top-left.svg')] bg-size-[100%_100%]`}
          aria-hidden="true"
        />
        <span
          className={`${LAYER_CLASS} left-[88.6945%] top-[16.812799%] h-[3.23488%] w-[4.5%] rotate-11 bg-[url('/images/cover/heart-white-top-right.svg')] bg-size-[100%_100%]`}
          aria-hidden="true"
        />
        <span
          className={`${LAYER_CLASS} left-[80.5%] top-[80.45007%] h-[3.23488%] w-[4.5%] rotate-6 bg-[url('/images/cover/heart-white-bottom-right.svg')] bg-size-[100%_100%]`}
          aria-hidden="true"
        />

        <div
          className={`${TEXT_CLASS} left-[6.547625%] top-[7.6%] flex h-[8.572771%] w-[86.90475%] items-center justify-center overflow-visible`}
        >
          <Handwriting
        ...
        <p
          className={`${TEXT_CLASS} left-[60.84925%] top-[87.495921%] flex h-[8.840661%] w-[33.09525%] items-center justify-end text-right text-[clamp(18px,5.75vw,25.76px)] leading-[1.3] supports-[font-size:1cqw]:text-[5.75cqw]`}
        >
          {date}
        </p>
